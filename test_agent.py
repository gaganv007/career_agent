...
async def test_greeting():
    ...
    for msg in test_messages:
        ...
        if "error" in result:
            ...
            print_test_result(passed, "Greeting detected" if passed else "No greeting detected")
...
async def test_farewell():
    ...
    for msg in test_messages:
        ...
        if "error" in result:
            ...
            print_test_result(passed, "Farewell detected" if passed else "No farewell detected")
...
async def test_career_advice():
    ...
    for query in test_queries:
        ...
        if "error" in result:
            ...
            career_keywords = ['career', 'job', 'position', 'title', 'skill', 'experience', 'course']
            passed = any(kw in response.lower() for kw in career_keywords)
            print_test_result(passed, "Career advice detected" if passed else "Generic response")
...
async def test_schedule():
    ...
    for query in test_queries:
        ...
        if "error" in result:
            ...
            print_test_result(passed, "Schedule advice detected" if passed else "Generic response")
...
async def test_session_persistence():
    ...
    print_test_result(passed, "Context maintained" if passed else "Context not maintained")
...
async def test_guardrails():
    ...
    for query in blocked_queries:
        ...
        if "error" in result:
            ...
            passed = any(indicator in response.lower() for indicator in blocked_indicators)
            print_test_result(passed, "Guardrail active" if passed else "Guardrail may not be working")
...
async def test_response_time():
    ...
    if times:
        ...
        print_test_result(passed, f"Performance {'acceptable' if passed else 'needs improvement'}")
...
async def run_all_tests():
    ...
    if not await check_health():
        ...
        print(f"{Colors.YELLOW}Please start the server with: python api.py{Colors.RESET}\n")
        return
