...
SUB_AGENTS = {
    "cs633": build_agent(
        ...
        instruction=[
            ...
            "information for the orchestrator and other agents to use.",
    ...
    "schedule": build_agent(
        ...
        instruction=[
            ...
            "You do not interact with the user directly; instead, you gather "
            "information for the orchestrator and other agents to use.",
            "Your role is to cross-reference the user's class preferences",
    ...
    "document": build_agent(
        ...
        instruction=[
            ...
            "You do not interact with the user directly; instead, you gather "
            "information for the orchestrator and other agents to use.",
            "Your primary purpose is to: Accept documents"
...
orchestrator = build_agent(
    ...
    instruction=[
        ...
        "You work to seamlessly integrate the capabilities of all specialized sub-agents to deliver"
        "a coherent and personalized experience for users seeking academic and career guidance in Computer Information Systems.",
        "You manage all interactions between specialized sub-agents: Career_Agent, Course_Agent, Scheduling_Agent, Document_Agent, and Memory_Agent.",
        "You ensure that all sub-agents (Career, Course, Scheduling, Document, CS633 and Memory) collaborate efficiently "
        "and consistently to provide the user with personalized career and academic planning support.",
